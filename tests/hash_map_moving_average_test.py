...
from unbabel_cli.algorithm.hash_map_moving_average_algorithm import HashMapMovingAverageAlgorithm
...
class HashMapMovingAverageTest(TestCase):
    def setUp(self):
        self.algorithm = HashMapMovingAverageAlgorithm()
